      ...
      <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left m-200">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-pink-600 p-1 ml-80"                            src={'https://cdn-icons-png.flaticon.com/128/3135/3135715.png'} alt="profile"
                        />
                        <h1
                            className=' flex text-center font-bold text-2xl mb-2 pr-20 ml-80'
                            style={{ color: mode === 'dark' ? 'white' : 'black' }}
                        >
                            Profil accont
                        </h1>
                    </div>
                    <div className="right mr-0">
                        ...
                        <div className="relative overflow-x-auto shadow-md sm:rounded-xl">
                            ...
                            <table className="w-full border-2 border-white shadow-md text-sm text-left text-gray-500 dark:text-gray-400" >
                                ...
                                <thead
                                    ...
                                    className="text-xs  ">
                                    <tr>
                                        <th style={{ color: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }} scope="col" className="px-20 py-8">
                                            S.No
                                        </th>
                                        <th style={{ color: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }} scope="col" className="px-20 py-3">
                                            Thumbnail
                                        </th>
                                        <th style={{ color: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }} scope="col" className="px-20 py-3">
                                            Title
                                                ...
                                                <tbody>
                                                    <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                                        ...
                                                        <td onClick={()=> deleteBlogs(id)} style={{ color: mode === 'dark' ? 'white' : 'black' }} className="px-6 py-4">
                                                            <button className=' px-4 py-1 rounded-lg text-black font-bold bg-red-500'>Delete
                                                            </button>
                                                        </td>
                                                    </tr>
                                                </tbody>
